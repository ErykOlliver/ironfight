...
export default function Faq() {
    ...
    return (
        <section className='w-full h-fit flex flex-col gap-4 bg-obsidian items-center relative justify-center'>
            ...
            <header className='w-full gap-4 h-fit items-center relative z-2 px-7.5 pt-10 justify-center flex flex-col'>
                <h1 className='font-bebas-neue text-3xl text-forge-white text-center'><span className='text-iron-gold'>FAQ </span>(Perguntas Frequentes)</h1>
                <h2 className='font-inter text-md text-silver text-center'>Ainda com dúvida? A gente responde.</h2>
            </header>
            <article className='w-full px-7.5 h-fit flex flex-col relative z-2 items-center justify-center gap-4'>
                {faqs.map((f, index) => (
                    <Quest
                        key={index}
                        question={f.question}
            ...
            <article className='w-full gap-4 h-fit flex flex-col items-center px-7.5 z-2 justify-center'>
