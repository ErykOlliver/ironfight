...
export default function NavBar() {
    return (
        <>
            <div className='w-[95%] h-fit backdrop-blur-md shadow-xs shadow-black/50 bg-obsidian/85 items-center justify-between flex py-2 rounded-md border-[0.5] border-silver z-1000 px-7.5 fixed top-0 left-1/2 -translate-x-1/2 mt-2'>
